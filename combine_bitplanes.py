...
parser.add_argument("--out", "-o", help="Output location", default="./output/", required=False)
...
parser.add_argument("--color", "-c", help="Use color for the result", default=False, required=False)
parser.add_argument("--saveall", "-a", help="Save all bit planes", default=False, required=False)
